<?php 
  ...
  $incorrect_password = $incorrect_uid = $reg_success = $status =  "";
      ...
      switch ($_GET["for"]) {
        case 'useremail':
          $incorrect_uid = '<div class="alert alert-danger" role="alert">
                              <strong>Inccorrect User email</strong>
                          </div>';
          break;
        ...
        case 'status':
          $status = '<div class="alert alert-danger" role="alert">
                                  <strong>Your accound has been Banned</strong>
                                </div>';
          break;
              ...
              <div class="auth-form-light text-left p-5">
                ...
                <form action="login.php" method="post" class="pt-3">
                  <div class="form-group">
                    <input type="admin" name="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Your Email">
                  </div>
                  <div class="form-group">

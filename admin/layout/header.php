<?php 
    ...
    $adminFullName = $_SESSION["first_name"]." ".$_SESSION["last_name"];
    $adminGp = $_SESSION["group"];
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <div class="">
            <form action="admin.links.php" method="POST" class="forms-sample d-flex justify-content-between m-3 ">                            
              <div class="form-group">
                <input type="text" class="form-control form-control-sm" name="long_url" placeholder="Long_url"required>
              </div> 
              <div class="form-group">
                <input type="hidden" class="form-control form-control-xs" name="admin_id" value="<?=$adminId?>">
              </div>  
              <div class="form-group">
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black"><?=$adminFullName?></p>
                </div>
              </a>
